...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bodycopy_contentsection', (
        ...
        db.send_create_signal('bodycopy', ['ContentSection'])


    def backwards(self, orm):
        
        # Deleting model 'ContentSection'
        db.delete_table('bodycopy_contentsection')


    models = {
        'bodycopy.contentsection': {
