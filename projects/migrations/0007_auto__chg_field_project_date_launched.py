...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.date_launched'
        db.alter_column('projects_project', 'date_launched', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Project.date_launched'
        db.alter_column('projects_project', 'date_launched', self.gf('django.db.models.fields.DateField')(default=None))
    ...
    models = {
        ...
        'media.media': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'default': '1L', 'related_name': "'media'", 'to': "orm['media.MediaType']"})
        },
        'media.mediatype': {
        ...
        'projects.project': {
            ...
            'content': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_launched': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
