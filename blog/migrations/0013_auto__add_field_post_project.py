...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_post', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.project'
        db.delete_column('blog_post', 'project_id')
