...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field related_articles on 'Post'
        db.create_table('blog_post_related_articles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_post', models.ForeignKey(orm['blog.post'], null=False)),
            ('to_post', models.ForeignKey(orm['blog.post'], null=False))
        ))
        db.create_unique('blog_post_related_articles', ['from_post_id', 'to_post_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field related_articles on 'Post'
        db.delete_table('blog_post_related_articles')
