...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Post.pop_rank'
        db.delete_column('blog_post', 'pop_rank')

        # Adding field 'Post.popularity_rank'
        db.add_column('blog_post', 'popularity_rank', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Post.pop_rank'
        db.add_column('blog_post', 'pop_rank', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Deleting field 'Post.popularity_rank'
        db.delete_column('blog_post', 'popularity_rank')
